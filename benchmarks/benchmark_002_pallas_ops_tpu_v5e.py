...
FUSION_SHAPES = [
    ("batch=512   (512×1024×1024)",   512,  1024, 1024),
    ("batch=2048  (2048×1024×1024)", 2048,  1024, 1024),
    ("batch=4096  (4096×1024×1024)", 4096,  1024, 1024),
    ("batch=8192  (8192×1024×1024)", 8192,  1024, 1024),
]
